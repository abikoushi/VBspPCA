...
size = VBspPCA:::size_mtx("iris.mtx")
L = 2
system.time({
  out_an <- VBspPCA:::VBPCA_diag_bin(read_x = "x.bin",
                                     read_y = "y.bin",
                                     size = size,
                                     rank = L, maxit = 100,
                                     constr_type = "AN",
...
system.time({
  out_sn <- VBspPCA:::VBPCA_diag_bin(read_x = "x.bin",
                                     read_y = "y.bin",
                                     size = size,
                                     rank = L, maxit = 100,
                                     constr_type = "SN",
...
system.time({
  out_nn <- VBspPCA:::VBPCA_diag_bin(read_x = "x.bin",
                                     read_y = "y.bin",
                                     size = size,
                                     rank = L, maxit = 100,
                                     constr_type = "AN",
